...
<body class="mainbody">
    <div class="layui-container-tab">
        <div class="layui-row topfloatbar">
            <button type="button" class="layui-btn layui-btn-primary layui-btn-sm topfloatbar-title" disabled>标题：文档数据添加</button>
        ...
        <form class="layui-form layui-form-pane" action="">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="docname" id="docname" lay-verify="required" maxlength="64" autocomplete="off" placeholder="文档名称" class="layui-input" value="">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="orderbyid" id="orderbyid" lay-verify="" autocomplete="off" maxlength="64" placeholder="排序编号，越大越靠前" class="layui-input" value="100">
                </div>
            </div>
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block"">
                    ...
                    <textarea name="content" id="content" class="layui-textarea" placeholder="请输入markdown格式文档内容" style="height: 700px;"></textarea>
                </div>
