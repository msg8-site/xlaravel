...
<script type="text/javascript">
    $("document").ready(function() {
        var configurl_table       = '/loguserlogin_index_tabledata';
        var configurl_add         = '/loguserlogin_add';
        var configurl_add_exec    = '/loguserlogin_add_exec';
        var configurl_update      = '/loguserlogin_update';
        var configurl_update_exec = '/loguserlogin_update_exec';
        var configurl_delete      = '/loguserlogin_delete';
                ...
                <div class="layui-field-box">
                    <form class="layui-form layui-form-pane layui-form-search" action="">
                        <div class="layui-form-item">
                            ...
                            <label class="layui-form-label">登陆结果</label>
                            <div class="layui-input-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="loginname" maxlength="64" placeholder="登陆用户名 [全模糊]" autocomplete="off" class="layui-input">
                            </div>
                            <label class="layui-form-label">登陆IP地址</label>
                            <div class="layui-input-inline">
                                <input type="text" name="loginip" maxlength="64" placeholder="登陆IP地址 [全模糊]" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
