...
<body class="mainbody">
    <div class="layui-container-tab">
        <div class="layui-row topfloatbar">
            <button type="button" class="layui-btn layui-btn-primary layui-btn-sm topfloatbar-title" disabled>标题：菜单数据修改</button>
        ...
        <form class="layui-form layui-form-pane" action="">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" autocomplete="off" placeholder="" class="layui-input disabled-color" disabled value="{{ $resarr['data']['fid'] ?? '' }}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">菜单名称</label>
                <div class="layui-input-block">
                    <input type="text" name="menuname" id="menuname" lay-verify="required" maxlength="64" autocomplete="off" placeholder="菜单名称，建议控制在8个汉字以内" class="layui-input" value="{{ $resarr['data']['menuname'] ?? '' }}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">菜单路径</label>
                <div class="layui-input-block">
                    <input type="text" name="menupath" id="menupath" lay-verify="" autocomplete="off" maxlength="256" placeholder="菜单路径，举例：index，也可以填写外链url" class="layui-input" value="{{ $resarr['data']['menupath'] ?? '' }}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">desc排序ID</label>
                <div class="layui-input-block">
                    <input type="text" name="orderbyid" id="orderbyid" lay-verify="required|number" autocomplete="off" maxlength="7" placeholder="数值越大越靠前，默认100" class="layui-input" value="{{ $resarr['data']['orderbyid'] ?? '' }}">
                </div>
            </div>
            <div class="layui-form-item">
