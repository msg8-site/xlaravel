...
<script type="text/javascript">
    $("document").ready(function() {
        var configurl_table       = '/role_index_tabledata';
        var configurl_add         = '/role_add';
        var configurl_add_exec    = '/role_add_exec';
        var configurl_update      = '/role_update';
        var configurl_update_exec = '/role_update_exec';
        var configurl_delete      = '/role_delete';
                    ...
                    <form class="layui-form layui-form-pane layui-form-search" action="">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="rolename" maxlength="64" placeholder="角色名称 [全模糊]" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
