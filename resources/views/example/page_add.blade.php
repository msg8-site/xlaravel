...
<body class="mainbody">
    <div class="layui-container-tab">
        <div class="layui-row topfloatbar">
            <button type="button" class="layui-btn layui-btn-primary layui-btn-sm topfloatbar-title" disabled>标题：样例数据添加</button>
        ...
        <form class="layui-form layui-form-pane" action="">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="name" id="name" lay-verify="required" maxlength="64" autocomplete="off" placeholder="唯一标识名称" class="layui-input" value="">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">测试数据1</label>
                <div class="layui-input-block">
                    <input type="text" name="testdata1" id="testdata1" lay-verify="" autocomplete="off" maxlength="64" placeholder="测试数据1" class="layui-input" value="">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">测试数据2</label>
                <div class="layui-input-block">
                    <input type="text" name="testdata2" id="testdata2" lay-verify="" autocomplete="off" maxlength="64" placeholder="测试数据2" class="layui-input" value="">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">测试数据3</label>
                <div class="layui-input-block">
                    <input type="text" name="testdata3" id="testdata3" lay-verify="" autocomplete="off" maxlength="64" placeholder="测试数据3" class="layui-input" value="">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">测试数据4</label>
                <div class="layui-input-block">
                    <input type="text" name="testdata4" id="testdata4" lay-verify="" autocomplete="off" maxlength="64" placeholder="测试数据4" class="layui-input" value="">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">测试数据5</label>
                <div class="layui-input-block">
                    <input type="text" name="testdata5" id="testdata5" lay-verify="" autocomplete="off" maxlength="64" placeholder="测试数据5" class="layui-input" value="">
                </div>
            </div>
            <div class="layui-form-item">
