...
<script type="text/javascript">
    $("document").ready(function() {
        var configurl_table       = '/example_index_tabledata';
        var configurl_add         = '/example_add';
        var configurl_add_exec    = '/example_add_exec';
        var configurl_update      = '/example_update';
        var configurl_update_exec = '/example_update_exec';
        var configurl_delete      = '/example_delete';
                ...
                <div class="layui-field-box">
                    <form class="layui-form layui-form-pane layui-form-search" action="">
                        <div class="layui-form-item">
                            ...
                            <label class="layui-form-label">唯一标识名称</label>
                            <div class="layui-input-inline">
                                <input type="text" name="name" maxlength="64" placeholder="唯一标识名称 [全模糊]" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
